...
This section is only for scene-to-scene transitions. For shader backgrounds,
raymarched objects, particle fields, SDF ornaments, or procedural WebGL layers,
read the `shader-authoring` skill and use a timeline-driven canvas inside the
